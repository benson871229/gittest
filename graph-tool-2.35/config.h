...
/* copyright info */
#define COPYRIGHT "Copyright (C) 2006-2020 Tiago de Paula Peixoto\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."

/* c++ preprocessor compilation options */
#define CPPFLAGS "-DNDEBUG "

/* c++ compilation options */
#define CXXFLAGS "-fopenmp -O3 -fvisibility=default -fvisibility-inlines-hidden -Wno-deprecated -Wall -Wextra -ftemplate-backtrace-limit=0  -Wno-register"
...
#define GIT_COMMIT "a06d49a6"

/* git HEAD commit date */
#define GIT_COMMIT_DATE "Wed Sep 16 18:34:19 2020 +0200"
...
#define PACKAGE_STRING "graph-tool 2.35"
...
/* The directory name for the site-packages subdirectory of the standard
   Python install tree. */
#define PYTHON_DIR "/usr/lib/python3.8/site-packages"
